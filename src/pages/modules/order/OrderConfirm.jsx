...
const OrderConfirmed=()=>{
    ...
    return(
      <div className="w-full flex flex-col justify-center items-center">
        <div className="mb-8 mt-24 items-center justify-center w-full">
        ...
        <div className="flex justify-center flex-wrap gap-8 mt-6 border-t border-zinc-300 border-shadow w-[80%] pt-10">
